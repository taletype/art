    ...
    <main className="min-h-screen bg-black">
      <section className="section-shell pt-28">
        <div className="rounded-[2rem] border border-[#c9a227]/20 bg-gradient-to-br from-[#0d0d10] to-[#17171c] p-8 sm:p-10">
          ...
          <h1 className="max-w-4xl text-5xl leading-tight sm:text-6xl">Create the account, connect thirdweb, list the artwork, launch the auction.</h1>
          <p className="mt-4 max-w-2xl text-lg leading-8 text-white/68">
            This marketplace now supports a direct self-serve seller path powered by Supabase identity and thirdweb wallet-linked auction metadata.
          </p>
